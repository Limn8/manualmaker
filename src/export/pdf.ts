...
function renderTitlePage(project: Project): string {
  ...
  wrapText(ctx, project.title, PAGE_W / 2, PAGE_H / 2 - 40, PAGE_W - 300, 90);
  ctx.font = '32px "Segoe UI", "Malgun Gothic", sans-serif';
...
function renderStepPage(
  ...
  ctx.fill();
  ctx.fillStyle = '#ffffff';
  ctx.font = 'bold 36px "Segoe UI", "Malgun Gothic", sans-serif';
  ctx.textAlign = 'center';
  ...
  ctx.fillStyle = '#111318';
  ctx.font = 'bold 34px "Segoe UI", "Malgun Gothic", sans-serif';
